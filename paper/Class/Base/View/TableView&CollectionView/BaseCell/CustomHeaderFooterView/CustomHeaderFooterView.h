 ...
 */
- (void)customHeaderFooterView:(CustomHeaderFooterView *)customHeaderFooterView
                         event:(id)event;
...
+ (CellHeaderFooterDataAdapter *)dataAdapterWithData:(id)data
                                              height:(CGFloat)height
                                                type:(NSInteger)type;
...
+ (CellHeaderFooterDataAdapter *)fixedHeightTypeDataAdapterWithReuseIdentifier:(NSString *)reuseIdentifier
                                                                          data:(id)data
                                                                          type:(NSInteger)type;
