...
@interface CustomEditViewController ()
...
- (void)viewDidLoad {
    ...
    [self titleView:@"编辑"];
    [self setBackButton];
    [[TuSDKGeeV1Theme shared] setNavigationBarStyle:self.navigationController.navigationBar];
...
- (void)setRightButton
{
    ...
    button.showsTouchWhenHighlighted = YES;
    button.frame = CGRectMake(0, 0, 45, 25);
    [button addTarget:self action:@selector(onImageCompleteAction) forControlEvents:UIControlEventTouchUpInside];
