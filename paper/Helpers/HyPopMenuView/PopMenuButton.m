...
- (instancetype __nonnull)init
{
    ...
    if (self) {
        ...
        //2.文字大小
        self.titleLabel.font = FONT_PING_REGULAR(14.0f);
        //3.图片的内容模式
...
- (void)setTextLabelWithShadowColor:(UIColor*)color
{
    ...
    if (!textLabel) {
        ...
        textLabel.font = FONT_PING_REGULAR(14.0f);;
        [self addSubview:textLabel];
    }
    [textLabel setFrame:CGRectMake(0, CGRectGetHeight(self.bounds) - 25, CGRectGetWidth(self.bounds), 20)];
