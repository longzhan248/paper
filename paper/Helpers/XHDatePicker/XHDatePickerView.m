...
- (void)setupUI {
    ...
    self.themeColor = kUIColorFromRGB(MAIN_COLOR);
...
- (void)addLabelWithName:(NSArray *)nameArr {
    ...
    for (int i=0; i<nameArr.count; i++) {
        ...
        label.font = FONT_PING_REGULAR(14.0f);
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    if (!customLabel) {
        ...
        [customLabel setFont:FONT_PING_REGULAR(16.0f)];
    }
    NSString *title;
    ...
    customLabel.textColor = kUIColorFromRGB(BLACK);
    return customLabel;
}
...
- (void)show {
    ...
    [UIView animateWithDuration:.5 animations:^{
        self.bottomConstraint.constant = (ScreenHeight-280)/2;
